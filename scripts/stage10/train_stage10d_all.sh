#!/bin/bash
# Stage 10d: d_model=32, enc=2, dec=10, valid_weight=0.25
set -e
OUTDIR=${1:-_agent/cache/runs/stage10/10d-d32-2enc-10dec}
SEEDS=${2:-1,2,3,4,5}
mkdir -p "$OUTDIR"
...
echo "=== Stage 10d: d=32, enc=2, dec=10, valid_weight=0.25 ===" | tee -a "$LOG"
