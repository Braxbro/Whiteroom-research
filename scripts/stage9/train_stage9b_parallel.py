...
from _agent.scripts.stage9.train_stage9b import train_stage9b
...
def _seed_worker(seed, outdir, kwargs, comp_q, attr_q, curr_q):
    ...
    checkpoint_dir = str(Path(outdir) / f"stage9b-seed{seed}")
    train_stage9b(
...
def train_stage9b_parallel(
    ...
    **kwargs,
    ...
    """Launch Stage 9b training for all seeds in parallel."""
    outdir = Path(outdir)
